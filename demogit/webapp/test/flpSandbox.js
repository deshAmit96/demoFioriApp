		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "demo app to learn GIT",
									"targetURL": "#amittraildemogit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"amittraildemogit-display": {
								"semanticObject": "amittraildemogit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=amit.trail.demogit",
									"url": sap.ui.require.toUrl("amit/trail/demogit")
								}
							}
						}
					}
